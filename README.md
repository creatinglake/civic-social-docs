...
- **`ecosystem/`** — the four canonical specifications that anchor
  ...
  **[Civic Activity](ecosystem/civic-activity-spec.md)** (`civic-activity-spec.md`),
  ...
  layer, the authorization model note, the architecture baseline, the
  AI documents, and the
  **[Assisted Creation & Managed Hosting](ecosystem/assisted-creation-and-hosting.md)**
  concept document. These are the ideas everything else builds on.

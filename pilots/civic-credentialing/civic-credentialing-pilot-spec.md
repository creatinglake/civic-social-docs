...
- **[Civic Space Specification](../../specs/civic-space-spec.md)** — the host contract for the spaces where badges are displayed, including the Badge / Credential Object (§4.13) and the infrastructure-role taxonomy (§1.5).
- **[Civic Activity Specification](../../specs/civic-activity-spec.md)** — the distribution layer through which credential lifecycle events become visible across the ecosystem.

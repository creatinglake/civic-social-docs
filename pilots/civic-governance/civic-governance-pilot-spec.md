...
- **[Civic Space Specification](../../ecosystem/civic-space-spec.md)**, **[Civic Process Specification](../../ecosystem/civic-process-spec.md)**, **[Civic Activity Specification](../../ecosystem/civic-activity-spec.md)**, and **[Civic Identity Specification](../../ecosystem/civic-identity-spec.md)** — the four canonical specifications whose governance this pilot designs.
...
**Normative specifications** — the four canonical specs ([Space](../../ecosystem/civic-space-spec.md), [Process](../../ecosystem/civic-process-spec.md), [Activity](../../ecosystem/civic-activity-spec.md), [Identity](../../ecosystem/civic-identity-spec.md)) and their companions (the [plugin architecture](../../ecosystem/civic-plugin-architecture-spec.md), the [discovery layer](../../ecosystem/discovery-layer-spec.md), the [authorization model note](../../ecosystem/authorization-model-note.md)).
...
| [Civic Space Specification](../../ecosystem/civic-space-spec.md) §11 | Specification stewardship and versioning. | §15, §16 |

...
- **[Civic Activity Specification](../../specs/civic-activity-spec.md)** — the protocol-level definition of a Civic Activity: envelope schema, activity types, visibility, transport, and the ActivityStreams bridge roadmap. Everything this pilot aggregates is a Civic Activity.
...
- **[Civic Space Specification](../../specs/civic-space-spec.md)** — the scoped host contract of the spaces whose activity the feed aggregates (§1.3–1.6) and the Space API Profile whose endpoints the feed consumes (§7).

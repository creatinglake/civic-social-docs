...
These narratives are illustrative. Several characters and locations carry forward from the [Before & After](../case/before-and-after.md) document so readers can build on a familiar cast. Floyd County, Virginia is referenced as the actual rural pilot context; Athens, Virginia and Agora are the running fictional stand-ins for a small town and a city neighborhood.
